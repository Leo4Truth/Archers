...
function Arm(XPos, YPos, order, currentNum, texture){
    ...
    this.mIcon.getXform().setPosition(this.XPos + Armory.eCellOffsets[this.mOrder][0], 
...
//Arm.prototype.drawTextbox = function(aCamera) {
//    this.mIcon.draw(aCamera);
//    //this.mMessageBox.draw(aCamera);
//};
...
Arm.prototype.getWeapon = function (inc) {
    this.mCurrentNum += inc;
    if(this.mCurrentNum >= 100)
        this.mCurrentNum = 99;
};

Arm.prototype.useWeapon = function (dec) {
